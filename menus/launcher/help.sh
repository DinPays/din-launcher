...
menu_manage_launcher_help ()
{
    ...
    text_white "    you can change the base repository path with a different Github repo (if you want to pull Core code from a custom path)."
    echo

    text_yellow "    Configure Core Directory (A)"
    text_white "    lets you configure the directory base is installed into when you select Install DinPay Core (you can change this before you start the base installation)."
    echo
    ...
    text_white "    lets you configure a different custom token (DinPay by default)."
    echo
    ...
    text_white "    lets you configure the directory where the Explorer is installed into when you do an DinPay Explorer installation (you can change this before you start the explorer installation)."
    echo
